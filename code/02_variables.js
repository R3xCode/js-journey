const acctId = 8762862; // accId cannot be updated because it is a constant
let accEmail = "xyz@gmail.com"; // let allows reassignment
...
accEmail = "axoi@gmail.com"; // accEmail is reassigned
accPassword = "52790028261"; // accPassword is reassigned
accountState = "Assam"; // accountState is initialized
accCity = "Tezpur"; // accCity is reassigned

console.log(acctId); // Outputs the constant account ID
